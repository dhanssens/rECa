...
%  speed. If no initial ECa estimation is included, a Guillemoteau et 
%  al. (2015) based approach is used. However, with an updated forward
%  model (github.com/dhanssens).
%
%  Input:
